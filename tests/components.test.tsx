...
describe('UI Components', () => {
  ...
  it('renders and interacts with CopyUrlToast upon receiving message', async () => {
    ...
    await act(async () => {
      await msgListener({ type: MESSAGE_TYPES.COPY_CURRENT_URL, url: 'https://example.com' })
    })
  ...
  it('renders BangForm in edit mode and allows canceling edit', () => {
    ...
    expect(screen.getByRole('button', { name: /Update Bang/i })).toBeInTheDocument()
  ...
  it('renders BookmarkForm in edit mode and BookmarksList with edit/delete', () => {
    ...
    render(
      <BookmarksList
        bookmarks={[{ id: '1', title: 'My Bookmark', url: 'https://mybookmark.com', dateAdded: 12345 }]}
        searchFilter=""
        onSearchFilterChange={vi.fn()}
        onEdit={onEdit}
        onDelete={onDelete}
  ...
  it('renders SettingsView with themes and shortcuts', () => {
    ...
    expect(onPreferenceChange).toHaveBeenCalledWith('enableBackgroundBlur', false)
  })
})
